      ...
      <Grid container spacing={5} mt={5}>
        <Grid item xs={5}>
          <div className="flex justify-start items-center border rounded-md border-white py-2">
            ...
            <Typography color={"black"} sx={{marginRight:2}}>Tư Vấn Mua Hàng : </Typography>
            <Typography color={"#DD5746"}>0369.371.693</Typography>
          </div>
        </Grid>
        <Grid item xs={5}>
        <div className="flex justify-start items-center border rounded-md border-white py-2">
            <img className="mx-5" src="https://cellphones.com.vn/smember/_nuxt/img/waranty%201.a9ef39d.png"></img>
            <Typography color={"black"} sx={{marginRight:2}}>Bảo Hành : </Typography>
            <Typography color={"#DD5746"}>0369.371.693</Typography>
          </div>
        </Grid>
        <Grid item xs={5}>
        <div className="flex justify-start items-center border rounded-md border-white py-2">
            ...
            <Typography color={"black"} sx={{marginRight:2}}>Khiếu Nại : </Typography>
            <Typography color={"#DD5746"}>0369.371.693</Typography>
          </div>
        </Grid>
        <Grid item xs={5}>
        <div className="flex justify-start items-center border rounded-md border-white py-2">
            ...
            <Typography color={"black"} sx={{marginRight:2}}>Email : </Typography>
            <Typography color={"#DD5746"}>duccong@gmail.com</Typography>
          </div>
        </Grid>
      </Grid>
    </div>
